...
class Phonedetails extends StatefulWidget {
  final id;
  Phonedetails({this.id});

  @override
  State<Phonedetails> createState() => _PhonedetailsState(i: this.id);
}

class _PhonedetailsState extends State<Phonedetails> {
  final i;
  _PhonedetailsState({this.i});

  Future getData() async {
    var url = Uri.parse('http://10.0.2.2/mastershop/mobiledetails.php');
