...
class Watchdetails extends StatefulWidget {
  final id;
  Watchdetails({this.id});

  @override
  State<Watchdetails> createState() => _WatchdetailsState(i: this.id);
}

class _WatchdetailsState extends State<Watchdetails> {
  final i;
  _WatchdetailsState({this.i});

  Future getData() async {
    var url = Uri.parse('http://10.0.2.2/mastershop/watchdetails.php');
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: snapshot.data[0]['screen_type']
                                              .toString(),
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text:
                                              "${snapshot.data[0]['screen_size']} mm"
                                                  .toString(),
                                          style: TextStyle(
                                              color: Color.fromARGB(
                                                  204, 233, 30, 98)))
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: snapshot.data[0]['connection']
                                              .toString(),
                                          style: TextStyle(color: Colors.white))
                                    ]),
                              ),
