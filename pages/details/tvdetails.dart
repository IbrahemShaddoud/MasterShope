...
class Tvdetails extends StatefulWidget {
  ...
  @override
  State<Tvdetails> createState() => _TvdetailsState(i: this.id);
}

class _TvdetailsState extends State<Tvdetails> {
  final i;
  _TvdetailsState({this.i});

  Future getData() async {
    var url = Uri.parse('http://10.0.2.2/mastershop/tvdetails.php');
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text:
                                              "${snapshot.data[0]['screen_size']} inches"
                                                  .toString(),
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: snapshot.data[0]['aspect_ratio']
                                              .toString(),
                                          style: TextStyle(color: Colors.white))
                                    ]),
                              ),
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: snapshot.data[0]['mothion_rat']
                                              .toString(),
                                          style: TextStyle(
                                            color: Color.fromARGB(
                                                204, 233, 30, 98),
