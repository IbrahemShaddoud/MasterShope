...
class Lapdetails extends StatefulWidget {
  ...
  @override
  State<Lapdetails> createState() => _LapdetailsState(i: this.id);
}

class _LapdetailsState extends State<Lapdetails> {
  final i;
  _LapdetailsState({this.i});

  Future getData() async {
    var url = Uri.parse('http://10.0.2.2/mastershop/laptopdetails.php');
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text:
                                              "${snapshot.data[0]['ram'].toString()} GB",
                                          style: TextStyle(color: Colors.white))
                                    ]),
                              ),
                            ],
